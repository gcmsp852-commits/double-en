...
// ★ システム暗号化復号用：通常のreadFormatInformationで読み取り、マスク番号を反転する
// システム暗号化は有効な型式情報を書き込む（反転マスク+正しいBCH）ため、
// 通常のFORMAT_INFO_TABLE lookupで正しく読み取れる。マスク番号だけ反転すればよい。
// この方式は通常のreadFormatInformationのハミング距離耐性（最大3ビットエラー）を継承する。
